...
{\color{incolor}In [{\color{incolor}1}]:} \PY{c+c1}{\PYZsh{} Import libraries necessary for this project}
        ...
        \PY{n}{data} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{read\PYZus{}csv}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{dataset/census.csv}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}2}]:} \PY{c+c1}{\PYZsh{} TODO: Total number of records}
        ...
        \PY{n}{greater\PYZus{}percent} \PY{o}{=} \PY{n}{n\PYZus{}greater\PYZus{}50k} \PY{o}{/} \PY{n}{n\PYZus{}records}
        ...
        \PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Percentage of individuals making more than \PYZdl{}50,000: }\PY{l+s+si}{\PYZob{}:2.2\PYZpc{}\PYZcb{}}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{greater\PYZus{}percent}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}4}]:} \PY{c+c1}{\PYZsh{} Log\PYZhy{}transform the skewed features}
        ...
        \PY{n}{features\PYZus{}log\PYZus{}transformed} \PY{o}{=} \PY{n}{features\PYZus{}raw}
        \PY{n}{features\PYZus{}log\PYZus{}transformed}\PY{p}{[}\PY{n}{skewed}\PY{p}{]} \PY{o}{=} \PY{n}{features\PYZus{}log\PYZus{}transformed}\PY{p}{[}\PY{n}{skewed}\PY{p}{]}\PY{o}{.}\PY{n}{apply}\PY{p}{(}\PY{k}{lambda} \PY{n}{x}\PY{p}{:} \PY{n}{np}\PY{o}{.}\PY{n}{log}\PY{p}{(}\PY{n}{x} \PY{o}{+} \PY{l+m+mi}{1}\PY{p}{)}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor}5}]:} \PY{c+c1}{\PYZsh{} Import sklearn.preprocessing.StandardScaler}
        ...
        \PY{n}{features\PYZus{}log\PYZus{}minmax\PYZus{}transform} \PY{o}{=} \PY{n}{features\PYZus{}log\PYZus{}transformed}
...
4      0.000000           0.0        0.397959            Cuba  
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}6}]:} \PY{n}{display}\PY{p}{(}\PY{n}{data}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{p}{)}\PY{p}{)}
\end{Verbatim}
...
with "\textgreater{}50K" to \texttt{1}.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}7}]:} \PY{c+c1}{\PYZsh{} TODO: One\PYZhy{}hot encode the \PYZsq{}features\PYZus{}log\PYZus{}minmax\PYZus{}transform\PYZsq{} data using pandas.get\PYZus{}dummies()}
        ...
        \PY{n}{income} \PY{o}{=} \PY{n}{income\PYZus{}raw}\PY{o}{.}\PY{n}{astype}\PY{p}{(}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{category}\PY{l+s+s1}{\PYZsq{}}\PY{p}{)}\PY{o}{.}\PY{n}{cat}\PY{o}{.}\PY{n}{codes}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}11}]:} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{income}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}11}]:} 11208
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}12}]:} \PY{n}{income}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{p}{)}
\end{Verbatim}


\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}12}]:} 45222
\end{Verbatim}
...
{\color{incolor}In [{\color{incolor}15}]:} \PY{l+s+sd}{\PYZsq{}\PYZsq{}\PYZsq{}}
         ...
         \PY{n}{accuracy} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{sum}\PY{p}{(}\PY{n}{income}\PY{p}{)} \PY{o}{/} \PY{n}{income}\PY{o}{.}\PY{n}{count}\PY{p}{(}\PY{p}{)}
         ...
         \PY{n}{fscore} \PY{o}{=} \PY{p}{(}\PY{p}{(}\PY{l+m+mi}{1}\PY{o}{*}\PY{n}{b}\PY{p}{)} \PY{o}{*} \PY{p}{(}\PY{n}{precision} \PY{o}{*} \PY{n}{recall}\PY{p}{)}\PY{o}{/}\PY{p}{(}\PY{p}{(}\PY{n}{b}\PY{o}{*}\PY{n}{precision}\PY{p}{)} \PY{o}{*} \PY{n}{recall}\PY{p}{)}\PY{p}{)}
...
\texttt{beta} parameter!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}23}]:} \PY{c+c1}{\PYZsh{} TODO: Import two metrics from sklearn \PYZhy{} fbeta\PYZus{}score and accuracy\PYZus{}score}
         \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{metrics} \PY{k}{import} \PY{n}{accuracy\PYZus{}score}\PY{p}{,} \PY{n}{fbeta\PYZus{}score}
...
implementation may take some time to run!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}26}]:} \PY{c+c1}{\PYZsh{} TODO: Import the three supervised learning models from sklearn}
         ...
         \PY{n}{clf\PYZus{}A} \PY{o}{=} \PY{n}{DecisionTreeClassifier}\PY{p}{(}\PY{n}{random\PYZus{}state}\PY{o}{=}\PY{l+m+mi}{42}\PY{p}{)}
         ...
         \PY{n}{samples\PYZus{}100} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)} \PY{o}{*} \PY{l+m+mi}{1}\PY{p}{)}
         \PY{n}{samples\PYZus{}10} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)} \PY{o}{*} \PY{o}{.}\PY{l+m+mi}{10}\PY{p}{)}
         \PY{n}{samples\PYZus{}1} \PY{o}{=} \PY{n+nb}{int}\PY{p}{(}\PY{n+nb}{len}\PY{p}{(}\PY{n}{y\PYZus{}train}\PY{p}{)} \PY{o}{*} \PY{o}{.}\PY{l+m+mi}{01}\PY{p}{)}
...
{\color{incolor}In [{\color{incolor} }]:} \PY{c+c1}{\PYZsh{} TODO: Import a supervised learning model that has \PYZsq{}feature\PYZus{}importances\PYZus{}\PYZsq{}}
        ...
        \PY{n}{importances} \PY{o}{=} \PY{k+kc}{None}
